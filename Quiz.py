...
# Question 2 - Lists
my_list = list(range(0, 101, 2))  # Create a list
print(my_list)

print(my_list[0:10])  # Printing the 1st ten elements of the list

print(len(my_list))  # Finding the length of the list

my_list.append(True)  # Appending a value to the list - can be any type
print(my_list)
...
for i in range(5):  # A pentagon has 5 sides!
    turtle.right(72)  # This is the angle needed to produced a pentagon
...
plt.plot(list1, list2, c="blue", liinewidth=1, label="A line!", linestyle="dashed",
         marker="s", markerfacecolor="purple", mrkersize=2)
plt.xlabel("X-axis")
plt.ylabel("Y-axis")
